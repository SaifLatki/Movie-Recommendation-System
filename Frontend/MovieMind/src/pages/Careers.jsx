  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-purple-950 via-black to-gray-900 py-16 px-4 sm:px-8 flex flex-col items-center">
      ...
      <div className="max-w-3xl mx-auto text-center space-y-6">
        ...
        >
          Join the MovieMind team and help us shape the future of movie discovery! We value creativity, innovation, and a love for movies.
        </motion.p>
        ...
        >
          <div className="bg-black/70 rounded-2xl p-6 border border-white/10 shadow-xl text-left">
            ...
            <p className="mt-4 text-purple-300">Send your CV to careers@moviemind.ai</p>
          </div>
        </motion.div>
      </div>
    </section>
